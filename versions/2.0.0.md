...
| [**service**](#entries) | `Array`   | ✔️        | `N/A`   | Service data (e.g. [Galileo][galileo])                           |
...
| [**queryString**](#querystring) | `Array`   | ✔️        | `N/A`   | List of query parameter [objects](#querystring)                                                                          |
...
###### New
- [`service`](#service)
- [`request.bodyCapture`](#request)
- [`response.bodyCapture`](#response)
- [`postData.encoding`](#postdata)
